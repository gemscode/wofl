...
# Generated on 2025-07-24 23:56:10.718014
...
class OptimizedTradingConfig:
    ...
    profit_target: float = 0.0050
    stop_loss: float = 0.0102
    confidence_threshold: float = 0.3214
    base_position_size: float = 0.0562
    max_position_size: float = 0.1124
    label_threshold_up: float = 0.0044
    label_threshold_down: float = -0.0032
