# src/agents/agent_core/cli/commands/integrity.py
import click
...
def integrity(check, fix, verbose, sync):  # Added sync parameter here
    ...
    try:
        ...
        # Core file/directory checks
        if not (check or fix or sync):
            from ...utils.integrity import check_project, format_report
